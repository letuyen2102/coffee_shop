...
<script src="{{ asset('/assets_admin/vendors/jvectormap/jquery-jvectormap.min.js') }}"></script>
<script src="{{ asset('/assets_admin/vendors/jvectormap/jquery-jvectormap-world-mill-en.js') }}"></script>
<script src="{{ asset('/assets_admin/vendors/owl-carousel-2/owl.carousel.min.js') }}"></script>
